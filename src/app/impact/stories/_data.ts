...
export const STORIES: Story[] = [
  ...
  { id: 5, name: "Thabo Nkosi", type: "Text story", program: "Computer Science", missionArea: "Public Health & Accessibility", humanitarianStatus: "None", nationality: "South Africa", disabilityStatus: "Visual Impairment", gender: "Male", location: "Johannesburg, South Africa", lat: -26.2041, lng: 28.0473, body: "Thabo developed accessible diagnostic software used in 30 clinics." },
  { id: 6, name: "Grace Achieng", type: "Text story", program: "BSc Software Eng", missionArea: "Digital Health", humanitarianStatus: "Internally Displaced Person", nationality: "Uganda", disabilityStatus: "None", gender: "Female", location: "Kampala, Uganda", lat: 0.3476, lng: 32.5825, body: "Grace created a low-bandwidth learning app for displaced students." },
  { id: 7, name: "Samuel Tesfaye", type: "Text story", program: "Global Challenges", missionArea: "Fitness & Preventive Health", humanitarianStatus: "None", nationality: "Ethiopia", disabilityStatus: "Emotional Condition and Developmental Disability", gender: "Male", location: "Addis Ababa, Ethiopia", lat: 9.0249, lng: 38.7469, body: "Samuel runs a clean-cooking enterprise reducing household emissions." },
  ...
  { id: 15, name: "Aisha Bello", type: "Video story", program: "Computer Science", missionArea: "Digital Health", humanitarianStatus: "None", nationality: "Nigeria", disabilityStatus: "Visual Impairment", gender: "Female", location: "Kano, Nigeria", lat: 12.0022, lng: 8.5920, body: "Aisha builds screen-reader-friendly learning tools for blind students.", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
  ...
  { id: 17, name: "Sarah Niyonsaba", type: "Text story", program: "Entrepreneurial Leadership", missionArea: "Public Health & Accessibility", humanitarianStatus: "Internally Displaced Person", nationality: "Rwanda", disabilityStatus: "None", gender: "Female", location: "Huye, Rwanda", lat: -2.5967, lng: 29.7392, body: "Sarah runs a community pharmacy network in underserved districts." },
  ...
  { id: 20, name: "Mariam Sow", type: "Text story", program: "Computer Science", missionArea: "Fitness & Preventive Health", humanitarianStatus: "None", nationality: "Senegal", disabilityStatus: "Emotional Condition and Developmental Disability", gender: "Female", location: "Saint-Louis, Senegal", lat: 16.0179, lng: -16.4896, body: "Mariam develops flood-prediction tools for coastal communities." },
];
