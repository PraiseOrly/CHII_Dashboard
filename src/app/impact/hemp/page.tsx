  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: EXEC_BG }}>
      ...
      <div className="max-w-[1440px] mx-auto px-6 py-7 space-y-10">
        ...
        {/* ── HealthX ──────────────────────────────────────────────────────── */}
        <section>
          <SectionHeader title="HealthX Experiential Learning" sub="Health facility visits, innovation challenges, field exposure, and industry tours" accent={TEAL} />
        ...
        {/* ── Internships ───────────────────────────────────────────────────── */}
        <section>
          <SectionHeader title="Internship & Placement Analytics" sub="Workplace training, employment conversions, and sector-level outcomes" accent={AMBER} />
        ...
        {/* ── Mission Students ─────────────────────────────────────────────── */}
        <section>
          <SectionHeader title="Mission Students Outcomes" sub="Cohort progression, track distribution, employment, and enterprise creation" accent={VIOLET} />
