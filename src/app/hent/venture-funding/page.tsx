          ...
          <div className="px-4 sm:px-6 py-6" style={{ position: "relative", zIndex: 10, width: "100%" }}>
            <div style={{ textAlign: "center" }}>
              ...
              <p className="text-[11px] mt-1.5 font-medium" style={{ color: "rgba(190,228,214,0.78)" }}>
                Capital deployed across the HENT venture portfolio
              </p>
            </div>
          </div>
        </header>
      ...
      <div className="max-w-[1440px] mx-auto px-6 py-7">
        <div className="overflow-hidden" style={{ backgroundColor: "white", borderRadius: 10, border: "1px solid rgba(0,33,71,0.08)" }}>
          <div className="flex items-center gap-2.5" style={{ backgroundColor: "#2D6A4F", padding: "12px 20px" }}>
            ...
            <p className="text-[12px] font-semibold uppercase leading-none text-white" style={{ letterSpacing: "0.04em" }}>Venture Funding</p>
          </div>
          <div className="p-10 text-center">
            <p className="text-[13px] font-semibold text-gray-700">Funding analytics coming soon</p>
            <p className="text-[11px] text-gray-400 mt-1.5">
              This section will track funding rounds, amounts deployed and investor mix across HENT ventures.
            </p>
          </div>
        </div>
      </div>
