      ...
      <header style={{ position: "relative", overflow: "hidden", backgroundColor: "#102C5E", borderRadius: 12, minHeight: 120, display: "flex", alignItems: "center" }}>
        ...
        <div className="px-4 sm:px-6 py-6" style={{ position: "relative", zIndex: 10, width: "100%" }}>
          <div style={{ textAlign: "center" }}>
            ...
            <p className="text-[13px] sm:text-sm mt-2 font-medium" style={{ color: "rgba(181,212,244,0.78)" }}>Graduates who continue their education, the qualifications they pursue, where they study, and how they finance lifelong learning</p>
