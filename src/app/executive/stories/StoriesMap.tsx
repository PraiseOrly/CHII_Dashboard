  ...
  const renderMarkers = () => {
    ...
    stories.forEach(s => {
      const icon = L.divIcon({
        html: pin(s.type === "Video story" ? VIDEO_SVG : TEXT_SVG, s.type === "Video story" ? "#D45F2C" : "#60a5fa"),
    ...
    <div style={{ position: "relative", width: "100%", height: "100%", minHeight: 480 }}>
      ...
      <button onClick={resetView} title="Reset map view"
        style={{ position: "absolute", top: 10, right: 10, zIndex: 500, display: "inline-flex", alignItems: "center", gap: 5,
          fontSize: 11.5, fontWeight: 700, color: "var(--brand-secondary)", backgroundColor: "white", border: "1px solid rgba(0,33,71,0.15)",
