    ...
    <div className="min-h-screen" style={{ backgroundColor: "#f8fafc" }}>
      ...
      <header style={{ position: "relative", overflow: "hidden", backgroundColor: "#2D6A4F", borderRadius: 12, minHeight: 120, display: "flex", alignItems: "center" }}>
        ...
        <div className="px-4 sm:px-6 py-6" style={{ position: "relative", zIndex: 10, width: "100%" }}>
          <div style={{ textAlign: "center" }}>
            ...
            <p className="text-[11px] mt-1.5 font-medium" style={{ color: "rgba(214,236,224,0.78)" }}>
      ...
      <div className="max-w-[1440px] mx-auto px-6 py-7 space-y-8">
        ...
        <div className="flex items-center gap-2.5 mb-1">
          ...
          <div>
            <h2 className="font-extrabold leading-tight" style={{ fontSize: 14, color: "#2D6A4F", letterSpacing: "0.01em" }}>Talent-Development Pipeline</h2>
            ...
            <div className="flex flex-wrap items-stretch justify-center gap-2">
              {pipelineSteps.map((s, i) => (
                <div key={s.label} className="flex items-stretch" style={{ flex: "1 1 120px" }}>
                  <div className="flex-1 rounded-lg text-center px-2 py-3" style={{ border: "1px solid rgba(45,106,79,0.12)", borderTop: "3px solid #2D6A4F" }}>
                    <p className="font-black tabular-nums" style={{ fontSize: 20, color: "#2D6A4F", lineHeight: 1 }}>{s.value}</p>
                  ...
                  {i < pipelineSteps.length - 1 && (
                    <div className="flex items-center px-0.5" style={{ color: "rgba(45,106,79,0.4)", fontSize: 16 }}>→</div>
                  )}
                </div>
              ))}
            </div>
        ...
        <div style={{ position: "relative", borderRadius: 12, overflow: "hidden", backgroundColor: "#2D6A4F", minHeight: 116, display: "flex", alignItems: "center" }}>
          ...
          <div style={{ position: "relative", zIndex: 10, width: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", gap: 8, padding: "18px 24px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: 11, color: "rgba(214,236,224,0.85)" }}><span style={{ color: "#B7E4C7", fontWeight: 600 }}>Source:</span> HEMP Programmes M&amp;E</span>
              <span style={{ fontSize: 11, color: "rgba(214,236,224,0.5)" }}>|</span>
