...
export default function ExposureEvents() {
  ...
  const categories = ["Reach & Engagement", "Quality & Impact"];
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 16 }}>
              <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 11, color: "#6B7280", marginTop: 3, margin: 0 }}>Event participation and audience growth</p>
                </div>
              </div>
            </div>
              ...
              <Panel title="Event Trend" subtitle="Annual event delivery" info="Annual trend of events delivered" filterOptions={["All Years", "2021", "2022", "2023", "2024", "2025", "2026"]} filterValue={filterYear} onFilterChange={setFilterYear}>
                <ResponsiveContainer width="100%" height={250}>
                  <LineChart data={eventTrendData} margin={{ top: 6, right: 14, bottom: 0, left: -12 }}>
                    ...
                    <Line type="monotone" dataKey="events" stroke={BRAND} strokeWidth={2.5} dot={{ r: 3 }} activeDot={{ r: 5 }} name="Events" />
                  </LineChart>
                </ResponsiveContainer>
              </Panel>

              <Panel title="Events by Type" subtitle="Distribution across formats">
                <ResponsiveContainer width="100%" height={250}>
                  <BarChart data={eventTypeData} margin={{ top: 6, right: 10, bottom: 0, left: -16 }} barCategoryGap="28%">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 16 }}>
              <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 11, color: "#6B7280", marginTop: 3, margin: 0 }}>Event completion and participant satisfaction</p>
                </div>
              </div>
            </div>
            <div style={{ marginBottom: 24 }} />
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }}>
              <Panel title="Completion Rates" subtitle="Success rates by event type">
                <ResponsiveContainer width="100%" height={250}>
